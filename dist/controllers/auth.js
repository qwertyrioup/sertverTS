...
const signin = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield User_1.default.findOne({ email: req.body.email }).populate("role");
        if (!user) {
        ...
        if (!user._doc) {
            ...
            return next((0, error_1.createError)(500, "User document is null"));
        }
        // @ts-ignore
        const _a = user._doc, { password } = _a, others = __rest(_a, ["password"]);
        res.status(200).json(Object.assign({}, others));
    }
    catch (err) {
